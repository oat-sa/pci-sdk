...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" style="enable-background:new 0 0 32 32" xml:space="preserve">
    ...
    <text xml:space="preserve" style="font-style:normal;font-weight:400;font-size:16px;line-height:1.25;font-family:sans-serif;letter-spacing:0;word-spacing:0;fill:#000;fill-opacity:1;stroke:none" x="3.23" y="21.824"><tspan x="3.23" y="21.824"><%=typeIdentifier.substring(0, 3).toUpperCase()%></tspan>
    </text>
</svg>
